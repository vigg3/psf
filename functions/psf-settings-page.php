        ...
        <tbody>
          ...
          <tr valign="top">
            <th scope="row">
              ...
              <a target="_blank" href="https://www.businessbloomer.com/woocommerce-visual-hook-guide-archiveshopcat-page/">Woocommerce
                Visual Hook Guide</a>
            </th>
            <td>
          ...
          <tr valign="top">
            <th scope="row">
              <h3>Position</h3>
              Hook för positionering av FAQ på övriga sidor.<br>
              <code>the_content</code> lägger till FAQn direkt efter innehållet.
            </th>
            <td>
              <div id="psf_page_visual_hook">
                <input type="text" id="page_visual_hook" placeholder="the_content" class="code" value="<?= esc_attr(get_option('page_visual_hook')); ?>" name="page_visual_hook" />
              </div>
            </td>
          </tr>
          <!-- Enabled pages -->
            ...
            <td>
              <div class="enabled_pages_wrapper">
                ...
                <div class="checkbox_wrapper">
                  <input type="checkbox" name="<?php echo $frontpage_id; ?>" id="<?php echo $frontpage_id; ?>" value="<?php echo $frontpage_id; ?>" <?php echo $isChecked ?> />
                ...
                foreach ($pages as $page) :
                  ...
                  <div class="checkbox_wrapper">
                    <input type="checkbox" name="<?php echo $page->ID; ?>" id="<?php echo $page->ID; ?>" value="<?php echo $page->ID; ?>" <?php echo $isChecked; ?> />
              ...
              <input type="text" hidden id="enabled_pages" name="enabled_pages" value="<?php echo get_option('enabled_pages'); ?>" />
            </td>
          </tr>
        </tbody>
      </table>

...
function psf_meta_box_display($term) {
  ...
  echo print_r($screen->taxonomy, true);
?>
<div>
  <tr class="form-field">
    <th scope="row">
          ...
          <tr>
            <td width="85%">
              ...
              <div class="faqAnswer">
                ...
                <textarea placeholder="Skriv svaret på frågan här" cols="55" rows="3"
          ...
          <tr>
            <td width="85%">
              <div class="faqQuestion">
                ...
                <input type="text" placeholder="Skriv frågan här" title="Fråga" name="faqQuestion[0]"
                  id="faqQuestion[0]">
              </div>
              <div class="faqAnswer">

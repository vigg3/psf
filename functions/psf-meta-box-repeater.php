...
?>
  ...
  <tr class="form-field">
    <th scope="row" valign="top"><label for="psf_faqs"><?php _e('FAQs', 'page-specific-faq'); ?></label></th>
    <td>
...
function custom_psf_meta_box_save($term_id) {
  // if (!isset($_POST['psf_meta_box_nonce']) || !wp_verify_nonce($_POST['psf_meta_box_nonce'], 'psf_meta_box_nonce')) return;
  // if (!current_user_can('edit_post', $term_id)) return;
